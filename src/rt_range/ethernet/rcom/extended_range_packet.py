...
RCOM_extended_range = Packet([
    ...
    Field('hunter_pitch_angle', UShort, decode_value=convert_10_pow_m2, unit='deg'),
    Field('hunter_roll_angle', UShort, decode_value=convert_10_pow_m2, unit='deg'),
    Field('target_pitch_angle', UShort, decode_value=convert_10_pow_m2, unit='deg'),
    Field('target_roll_angle', UShort, decode_value=convert_10_pow_m2, unit='deg'),
