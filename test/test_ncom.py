...
class TestNCOM(TestCase):
    def test_init(self):
        self.assertIsInstance(NCOM, Packet)

    def test_parse(self):
        sample_packet = b'\xe7\x00\x00\x50\xc3\x00\xd0\x07\x00\xca\x80\xfe\x00\x00\x00\x00\x00\x00\x00\x00\x00' \
                        ...
                        b'\x00\x00\x00\x00\x0f\x06\x06\x06\x00'
        expected_values = (
